...
class CreateCompetitionGameDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('competition_game_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('competition_game_data');
    }
}
